 ...
 * @author X-rapido
 * http://www.open-open.com/code/view/1432300986802
 */
public class RandomValue {
     ...
     * @return
     */
    public static String getCollegeMajor() {
        int index = getNum(0, collegeMajor_suffix.length - 1);
        String collegeMajor = collegeMajor_suffix[index];
        return collegeMajor;
    }
    ...
    public static String getDepartment() {
        int index = getNum(0, department_suffix.length - 1);
        String department = department_suffix[index];
        return department;
    }
    ...
    public static Map<String, Object> getAddress() {
        ...
        String[] collegeMajor = getCollegeMajor().split("/");
        map.put("college", collegeMajor[0]);
        map.put("major", collegeMajor[1]);
